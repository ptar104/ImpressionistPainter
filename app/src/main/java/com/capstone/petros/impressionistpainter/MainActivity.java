...
public class MainActivity extends AppCompatActivity implements OnMenuItemClickListener {
    ...
    */
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menuCircle:
                ...
                return true;
            case R.id.menuX:
                Toast.makeText(this, "X Brush", Toast.LENGTH_SHORT).show();
                _impressionistView.setBrushType(BrushType.X);
                return true;
            case R.id.menuEdge:
                Toast.makeText(this, "Edge Brush", Toast.LENGTH_SHORT).show();
                _impressionistView.setBrushType(BrushType.Edge);
                return true;
        }
        return false;
    }

    public boolean onButtonClickRemixColors(View button) {
        _impressionistView.remixColors();
        return true;
    }

    public boolean onButtonClickSaveImage(View button) {
        _impressionistView.saveImage(getContentResolver());
        return true;
    }
     ...
     */
    /*
    // Commented out because I removed the  "Download Images" button
